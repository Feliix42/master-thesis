...
We additionally define conditionals and fixed-point combinators to realize recursive expressions\todo{@Sebastian: Should I elaborate on fixed-point combinator?} as well as free and state-modifying foreign functions.
...
We can now define this preliminary transformation as follows:\todo{Beautify equation}
\begin{center}
    \begin{tabular}{l c l}
