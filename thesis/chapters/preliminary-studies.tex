...
Most of the overhead stems from the spawning of the threads each operator lives in and the resulting management and movement of data between these threads.\todo{[when time] Produce a diagram showing overhead in comparison}
...
It also benefits from its deterministic execution model, exhibiting a lower variation in the measured values than STM.\todo{[when time] calculate standard deviation/show scatter plot}
